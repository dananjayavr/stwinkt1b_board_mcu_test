---
pagetitle: Release Notes for STTS751 Component
lang: en
...
<center>
# Release Notes for STTS751 Component Driver
...
This directory contains the STTS751 component drivers.
:::
...
<label for="collapse-section3" aria-hidden="true">V1.0.2 / 05-May-2020</label>
<div>			
...
- Fix bug in STTS751_TEMP_GetTemperatureLimitStatus
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on STTS751,
visit:
[STTS751](https://www.st.com/content/st_com/en/products/mems-and-sensors/temperature-sensors/stts751.html)
:::
::: {.column width="5%"}
